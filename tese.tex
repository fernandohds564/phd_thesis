...
\subsection{Standard Impedance Budget Effects}\label{ssec:imp_bud_effects}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{official_phase_1_imp_model.png}
