...
\subsection{Standard Impedance Budget Effects}\label{ssec:imp_bud_effects}
    ...
    \end{figure}
    shows the main beam parameters averaged over all the turns of the simulation for two different situations, with and without the \gls{ibs} effects. A strong instability appears between \SI{2.8}{\milli\ampere} and \SI{3.0}{\milli\ampere}, increasing the average energy spread of the to values larger than the ones where the effects of \gls{ibs} are considered.
    ...
    \end{figure}
    shows the Discrete Figure~\ref{fig:ph1_microwave_time_evolution}
    \begin{figure}
        \centering
